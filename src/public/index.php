  ...
  <body>
    ...
    <div class="w-4/5 bg-white ml-20 mr-20 mt-10 justify-center items-center shadow-xl">
      <form action="" method="post">
        <div class="inline">
          <input class="border-black h-5 w-50 p-4 border-2 bg-white" type="textarea" name="searchWord" placeholder="タスク名キーワード入力" value="<?php echo $search ??
              ''; ?>">
        </div>
        <div class="inline">
          ...
          <?php foreach ($taskForWeb as $task): ?>
            <tbody>
              <tr>
                ...
                <?php endif; ?>              
                <td class="border px-4 py-2">
                  <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 m-1 rounded">
                    <a href="./task/edit.php?taskId=<?php echo $task['id']; ?>">編集</a>
                  </button>
                </td>
                <td class="border px-4 py-2">
                  <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-3 px-4 rounded">
